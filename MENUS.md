...
| **Crafting** | `ItemCrafter` 7, `Workbench` 6, `ResearchTable` 5, `Recycler` 6, TechTree 2 | **half** | queue, cancel, station-proximity gate all work; the recycler landed (recycler v0). No blueprints, no research — and `DESIGN.md` §8 says blueprints survive a wipe |
