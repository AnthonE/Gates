...
| `WORLD.md` | the proposed register: an ancient obsidian/lapis/gold civilization, the coast→interior corruption gradient, the monument catalogue, the **ward** (a second regenerating health pool), falls that cost ward, and world states players switch on | **DESIGN — unspoken, and none of it built.** Owns the fiction and nothing in `crates/`. Its §7 is the useful half: five collisions with live gates, two of them real — the visual rubric scores an obsidian world as a defect by construction, and a ward invalidates `CONTENT.md` §4's TTK anchor *without reddening `test_content`* |
