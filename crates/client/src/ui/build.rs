...
pub fn shape_blurb(shape: u8) -> &'static str {
    match shape {
        ...
        SHAPE_FLOOR_FRAME => "An open floor for a stairwell. Walls stand on its rim.",
