...
pub const FIXTURES: [&str; 86] = [
    "v39_input_acks_only.bin",
    "v39_input_full.bin",
    "v39_snapshot_keyframe.bin",
    "v39_snapshot_delta.bin",
    "v39_snapshot_cap.bin",
    "v39_hello.bin",
    "v39_welcome.bin",
    "v39_refuse_full.bin",
    "v39_event_gather.bin",
    "v39_event_inv.bin",
    "v39_event_slot_harvested.bin",
    "v39_event_slot_respawned.bin",
    ...
    "v39_event_piece_removed.bin",
    "v39_event_deploy_removed.bin",
    "v39_event_stock.bin",
    "v39_action_use.bin",
    ...
    "v39_event_struct_hit_piece.bin",
    "v39_event_struct_hit_deploy.bin",
    ...
    "v39_action_move_box.bin",
    "v39_action_container.bin",
    "v39_action_container_close.bin",
    "v39_event_cont_sync.bin",
    "v39_event_cont_close.bin",
    "v39_action_repair_piece.bin",
    "v39_action_repair_deploy.bin",
    "v39_event_piece_repaired_piece.bin",
    "v39_event_piece_repaired_deploy.bin",
    "v39_action_throw_piece.bin",
    "v39_action_throw_deploy.bin",
    "v39_event_charge_placed_piece.bin",
    "v39_event_charge_placed_deploy.bin",
    "v39_challenge.bin",
    "v39_auth.bin",
    "v39_event_oven_lit.bin",
    "v39_event_oven_out.bin",
    ...
    "v39_action_move_world.bin",
    "v39_event_cont_sync_world.bin",
];
