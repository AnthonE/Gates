...
pub const FIXTURES: [&str; 83] = [
    "v31_input_acks_only.bin",
    "v31_input_full.bin",
    "v31_snapshot_keyframe.bin",
    "v31_snapshot_delta.bin",
    "v31_snapshot_cap.bin",
    "v31_hello.bin",
    "v31_welcome.bin",
    "v31_refuse_full.bin",
    "v31_event_gather.bin",
    "v31_event_inv.bin",
    "v31_event_slot_harvested.bin",
    "v31_event_slot_respawned.bin",
    ...
    "v31_event_piece_removed.bin",
    "v31_event_deploy_removed.bin",
    "v31_event_stock.bin",
    "v31_action_use.bin",
    ...
    "v31_event_struct_hit_piece.bin",
    "v31_event_struct_hit_deploy.bin",
    ...
    "v31_action_container.bin",
    "v31_action_container_close.bin",
    "v31_event_cont_sync.bin",
    "v31_event_cont_close.bin",
    "v31_action_repair_piece.bin",
    "v31_action_repair_deploy.bin",
    "v31_event_piece_repaired_piece.bin",
    "v31_event_piece_repaired_deploy.bin",
    "v31_action_throw_piece.bin",
    "v31_action_throw_deploy.bin",
    "v31_event_charge_placed_piece.bin",
    "v31_event_charge_placed_deploy.bin",
    "v31_challenge.bin",
    "v31_auth.bin",
    "v31_event_oven_lit.bin",
    "v31_event_oven_out.bin",
    // Appended rather than slotted beside `v31_event_door`: the
...
/// An arrow leaving a bow (wire v31): shooter, yaw, pitch, speed, drop.
///
