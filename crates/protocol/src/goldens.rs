...
pub const FIXTURES: [&str; 83] = [
    "v33_input_acks_only.bin",
    "v33_input_full.bin",
    "v33_snapshot_keyframe.bin",
    "v33_snapshot_delta.bin",
    "v33_snapshot_cap.bin",
    "v33_hello.bin",
    "v33_welcome.bin",
    "v33_refuse_full.bin",
    "v33_event_gather.bin",
    "v33_event_inv.bin",
    "v33_event_slot_harvested.bin",
    "v33_event_slot_respawned.bin",
    ...
    "v33_event_piece_removed.bin",
    "v33_event_deploy_removed.bin",
    "v33_event_stock.bin",
    "v33_action_use.bin",
    ...
    "v33_event_struct_hit_piece.bin",
    "v33_event_struct_hit_deploy.bin",
    ...
    "v33_action_container.bin",
    "v33_action_container_close.bin",
    "v33_event_cont_sync.bin",
    "v33_event_cont_close.bin",
    "v33_action_repair_piece.bin",
    "v33_action_repair_deploy.bin",
    "v33_event_piece_repaired_piece.bin",
    "v33_event_piece_repaired_deploy.bin",
    "v33_action_throw_piece.bin",
    "v33_action_throw_deploy.bin",
    "v33_event_charge_placed_piece.bin",
    "v33_event_charge_placed_deploy.bin",
    "v33_challenge.bin",
    "v33_auth.bin",
    "v33_event_oven_lit.bin",
    "v33_event_oven_out.bin",
