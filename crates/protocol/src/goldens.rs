...
pub const FIXTURES: [&str; 70] = [
    "v22_input_acks_only.bin",
    "v22_input_full.bin",
    "v22_snapshot_keyframe.bin",
    "v22_snapshot_delta.bin",
    "v22_snapshot_cap.bin",
    "v22_hello.bin",
    "v22_welcome.bin",
    "v22_refuse_full.bin",
    "v22_event_gather.bin",
    "v22_event_inv.bin",
    "v22_event_slot_harvested.bin",
    "v22_event_slot_respawned.bin",
    ...
    "v22_event_piece_removed.bin",
    "v22_event_deploy_removed.bin",
    "v22_event_stock.bin",
    "v22_action_use.bin",
    "v22_action_lock.bin",
    "v22_event_door.bin",
    ...
    "v22_event_struct_hit_piece.bin",
    "v22_event_struct_hit_deploy.bin",
    ...
    "v22_action_container.bin",
    "v22_action_container_close.bin",
    "v22_event_cont_sync.bin",
    "v22_event_cont_close.bin",
    "v22_action_repair_piece.bin",
    "v22_action_repair_deploy.bin",
    "v22_event_piece_repaired_piece.bin",
    "v22_event_piece_repaired_deploy.bin",
];
