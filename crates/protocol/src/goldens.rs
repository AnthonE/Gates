...
pub const FIXTURES: [&str; 74] = [
    "v24_input_acks_only.bin",
    "v24_input_full.bin",
    "v24_snapshot_keyframe.bin",
    "v24_snapshot_delta.bin",
    "v24_snapshot_cap.bin",
    "v24_hello.bin",
    "v24_welcome.bin",
    "v24_refuse_full.bin",
    "v24_event_gather.bin",
    "v24_event_inv.bin",
    "v24_event_slot_harvested.bin",
    "v24_event_slot_respawned.bin",
    ...
    "v24_event_piece_removed.bin",
    "v24_event_deploy_removed.bin",
    "v24_event_stock.bin",
    "v24_action_use.bin",
    "v24_action_lock.bin",
    "v24_event_door.bin",
    ...
    "v24_event_struct_hit_piece.bin",
    "v24_event_struct_hit_deploy.bin",
    ...
    "v24_action_container.bin",
    "v24_action_container_close.bin",
    "v24_event_cont_sync.bin",
    "v24_event_cont_close.bin",
    "v24_action_repair_piece.bin",
    "v24_action_repair_deploy.bin",
    "v24_event_piece_repaired_piece.bin",
    "v24_event_piece_repaired_deploy.bin",
    "v24_action_throw_piece.bin",
    "v24_action_throw_deploy.bin",
    "v24_event_charge_placed_piece.bin",
    "v24_event_charge_placed_deploy.bin",
];
