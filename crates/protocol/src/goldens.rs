...
pub const FIXTURES: [&str; 101] = [
    "v53_input_acks_only.bin",
    "v53_input_full.bin",
    "v53_snapshot_keyframe.bin",
    "v53_snapshot_delta.bin",
    "v53_snapshot_cap.bin",
    "v53_hello.bin",
    "v53_welcome.bin",
    "v53_refuse_full.bin",
    "v53_event_gather.bin",
    "v53_event_inv.bin",
    "v53_event_slot_harvested.bin",
    "v53_event_slot_respawned.bin",
    ...
    "v53_event_piece_removed.bin",
    "v53_event_deploy_removed.bin",
    "v53_event_stock.bin",
    "v53_action_use.bin",
    ...
    "v53_event_struct_hit_piece.bin",
    "v53_event_struct_hit_deploy.bin",
    ...
    "v53_action_move.bin",
    "v53_event_moved.bin",
    "v53_event_move_refused.bin",
    "v53_action_move_box.bin",
    "v53_action_container.bin",
    "v53_action_container_close.bin",
    "v53_event_cont_sync.bin",
    "v53_event_cont_close.bin",
    "v53_action_repair_piece.bin",
    "v53_action_repair_deploy.bin",
    "v53_event_piece_repaired_piece.bin",
    "v53_event_piece_repaired_deploy.bin",
    "v53_action_throw_piece.bin",
    "v53_action_throw_deploy.bin",
    "v53_event_charge_placed_piece.bin",
    "v53_event_charge_placed_deploy.bin",
    "v53_challenge.bin",
    "v53_auth.bin",
    "v53_event_oven_lit.bin",
    "v53_event_oven_out.bin",
    ...
    "v53_action_move_world.bin",
    "v53_event_cont_sync_world.bin",
    ...
    "v53_action_move_wear.bin",
    "v53_event_cont_sync_wear.bin",
    "v53_event_move_refused_wear.bin",
