...
pub const FIXTURES: [&str; 83] = [
    "v34_input_acks_only.bin",
    "v34_input_full.bin",
    "v34_snapshot_keyframe.bin",
    "v34_snapshot_delta.bin",
    "v34_snapshot_cap.bin",
    "v34_hello.bin",
    "v34_welcome.bin",
    "v34_refuse_full.bin",
    "v34_event_gather.bin",
    "v34_event_inv.bin",
    "v34_event_slot_harvested.bin",
    "v34_event_slot_respawned.bin",
    ...
    "v34_event_piece_removed.bin",
    "v34_event_deploy_removed.bin",
    "v34_event_stock.bin",
    "v34_action_use.bin",
    ...
    "v34_event_struct_hit_piece.bin",
    "v34_event_struct_hit_deploy.bin",
    ...
    "v34_action_container.bin",
    "v34_action_container_close.bin",
    "v34_event_cont_sync.bin",
    "v34_event_cont_close.bin",
    "v34_action_repair_piece.bin",
    "v34_action_repair_deploy.bin",
    "v34_event_piece_repaired_piece.bin",
    "v34_event_piece_repaired_deploy.bin",
    "v34_action_throw_piece.bin",
    "v34_action_throw_deploy.bin",
    "v34_event_charge_placed_piece.bin",
    "v34_event_charge_placed_deploy.bin",
    "v34_challenge.bin",
    "v34_auth.bin",
    "v34_event_oven_lit.bin",
    "v34_event_oven_out.bin",
