...
pub const FIXTURES: [&str; 82] = [
    "v32_input_acks_only.bin",
    "v32_input_full.bin",
    "v32_snapshot_keyframe.bin",
    "v32_snapshot_delta.bin",
    "v32_snapshot_cap.bin",
    "v32_hello.bin",
    "v32_welcome.bin",
    "v32_refuse_full.bin",
    "v32_event_gather.bin",
    "v32_event_inv.bin",
    "v32_event_slot_harvested.bin",
    "v32_event_slot_respawned.bin",
    ...
    "v32_event_piece_removed.bin",
    "v32_event_deploy_removed.bin",
    "v32_event_stock.bin",
    "v32_action_use.bin",
    ...
    "v32_event_struct_hit_piece.bin",
    "v32_event_struct_hit_deploy.bin",
    ...
    "v32_action_container.bin",
    "v32_action_container_close.bin",
    "v32_event_cont_sync.bin",
    "v32_event_cont_close.bin",
    "v32_action_repair_piece.bin",
    "v32_action_repair_deploy.bin",
    "v32_event_piece_repaired_piece.bin",
    "v32_event_piece_repaired_deploy.bin",
    "v32_action_throw_piece.bin",
    "v32_action_throw_deploy.bin",
    "v32_event_charge_placed_piece.bin",
    "v32_event_charge_placed_deploy.bin",
    "v32_challenge.bin",
    "v32_auth.bin",
    "v32_event_oven_lit.bin",
    "v32_event_oven_out.bin",
