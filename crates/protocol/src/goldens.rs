...
pub const FIXTURES: [&str; 83] = [
    "v35_input_acks_only.bin",
    "v35_input_full.bin",
    "v35_snapshot_keyframe.bin",
    "v35_snapshot_delta.bin",
    "v35_snapshot_cap.bin",
    "v35_hello.bin",
    "v35_welcome.bin",
    "v35_refuse_full.bin",
    "v35_event_gather.bin",
    "v35_event_inv.bin",
    "v35_event_slot_harvested.bin",
    "v35_event_slot_respawned.bin",
    ...
    "v35_event_piece_removed.bin",
    "v35_event_deploy_removed.bin",
    "v35_event_stock.bin",
    "v35_action_use.bin",
    ...
    "v35_event_struct_hit_piece.bin",
    "v35_event_struct_hit_deploy.bin",
    ...
    "v35_action_container.bin",
    "v35_action_container_close.bin",
    "v35_event_cont_sync.bin",
    "v35_event_cont_close.bin",
    "v35_action_repair_piece.bin",
    "v35_action_repair_deploy.bin",
    "v35_event_piece_repaired_piece.bin",
    "v35_event_piece_repaired_deploy.bin",
    "v35_action_throw_piece.bin",
    "v35_action_throw_deploy.bin",
    "v35_event_charge_placed_piece.bin",
    "v35_event_charge_placed_deploy.bin",
    "v35_challenge.bin",
    "v35_auth.bin",
    "v35_event_oven_lit.bin",
    "v35_event_oven_out.bin",
