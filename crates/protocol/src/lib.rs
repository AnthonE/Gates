...
/// v75 adds the pack call: `SUB_HOWL` carries the tagged roster id of an
/// animal that howled for its pack (`EV_HOWL`, the animal brain). A new
/// subtype only — no field of any existing message moved.
