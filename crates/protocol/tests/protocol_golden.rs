...
use protocol::goldens::{
    ...
    action_container, action_container_close, action_move, action_move_box, action_place,
    action_respawn, action_upgrade, action_use, chat, event_bag_dropped,
    ...
    event_cont_close, event_cont_sync, event_struct_hit_deploy, event_struct_hit_piece,
    event_vitals, event_weak_mark, hello,
...
use protocol::{
    ...
    encode_action_container, encode_action_lock, encode_action_loot, encode_action_move,
    encode_action_place,
    ...
    encode_event_cont_sync, encode_event_weak_mark, encode_hello, encode_input, encode_refuse,
    encode_snapshot, encode_welcome, peek_kind, ActionMsg, ChatMsg, EventMsg, InputDatagram,
    InvSlot, WireError,
    BAG_SYNC_BATCH, CATALOG_BATCH, CONT_SYNC_BATCH, DEPLOY_SYNC_BATCH, KIND_ACTION, KIND_CHAT, KIND_EVENT,
...
const GOLDEN: [&[u8]; 66] = [
    ...
    include_bytes!("golden/v19_action_container.bin"),
    include_bytes!("golden/v19_action_container_close.bin"),
    include_bytes!("golden/v19_event_cont_sync.bin"),
    include_bytes!("golden/v19_event_cont_close.bin"),
];
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v19_action_container.bin" | "v19_action_container_close.bin" => {
            let (kind, cont) = if name == "v19_action_container.bin" {
                action_container()
            } else {
