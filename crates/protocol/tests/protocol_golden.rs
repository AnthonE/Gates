...
use protocol::goldens::{
    ...
    event_weak_mark, event_wounded, hello, input_acks_only, input_full, refuse_full, snapshot_cap,
...
use protocol::{
    ...
    encode_action_reload, encode_action_repair, encode_action_research, encode_action_respawn,
    encode_action_throw, encode_action_unlock, encode_action_upgrade, encode_action_use,
    ...
    encode_event_wounded, encode_hello, encode_input, encode_refuse, encode_snapshot,
    encode_welcome, peek_kind, ActionMsg, ChatMsg, EventMsg, InputDatagram, InvSlot, WireError,
    BAG_SYNC_BATCH, CATALOG_BATCH, CONT_SYNC_BATCH, DEPLOY_SYNC_BATCH, GITEM_SYNC_BATCH,
...
const GOLDEN: [&[u8]; 111] = [
    include_bytes!("golden/v69_input_acks_only.bin"),
    include_bytes!("golden/v69_input_full.bin"),
    include_bytes!("golden/v69_snapshot_keyframe.bin"),
    include_bytes!("golden/v69_snapshot_delta.bin"),
    include_bytes!("golden/v69_snapshot_cap.bin"),
    include_bytes!("golden/v69_hello.bin"),
    include_bytes!("golden/v69_welcome.bin"),
    include_bytes!("golden/v69_refuse_full.bin"),
    include_bytes!("golden/v69_event_gather.bin"),
    include_bytes!("golden/v69_event_inv.bin"),
    include_bytes!("golden/v69_event_slot_harvested.bin"),
    include_bytes!("golden/v69_event_slot_respawned.bin"),
    include_bytes!("golden/v69_event_slot_sync.bin"),
    include_bytes!("golden/v69_event_catalog.bin"),
    include_bytes!("golden/v69_event_weak_mark.bin"),
    include_bytes!("golden/v69_event_craft_q.bin"),
    include_bytes!("golden/v69_event_craft_done.bin"),
    include_bytes!("golden/v69_event_craft_refused.bin"),
    include_bytes!("golden/v69_event_recipes.bin"),
    include_bytes!("golden/v69_action_craft.bin"),
    include_bytes!("golden/v69_action_cancel.bin"),
    include_bytes!("golden/v69_action_place.bin"),
    include_bytes!("golden/v69_event_piece_placed.bin"),
    include_bytes!("golden/v69_event_piece_sync.bin"),
    include_bytes!("golden/v69_event_build_refused.bin"),
    include_bytes!("golden/v69_event_piece_defs.bin"),
    include_bytes!("golden/v69_action_deploy.bin"),
    include_bytes!("golden/v69_action_feed.bin"),
    include_bytes!("golden/v69_event_deploy_placed.bin"),
    include_bytes!("golden/v69_event_deploy_sync.bin"),
    include_bytes!("golden/v69_event_deploy_refused.bin"),
    include_bytes!("golden/v69_event_deploy_defs.bin"),
    include_bytes!("golden/v69_event_piece_removed.bin"),
    include_bytes!("golden/v69_event_deploy_removed.bin"),
    include_bytes!("golden/v69_event_stock.bin"),
    include_bytes!("golden/v69_action_use.bin"),
    include_bytes!("golden/v69_action_access.bin"),
    include_bytes!("golden/v69_event_door.bin"),
    include_bytes!("golden/v69_action_upgrade.bin"),
    include_bytes!("golden/v69_chat.bin"),
    include_bytes!("golden/v69_event_chat.bin"),
    include_bytes!("golden/v69_event_hit.bin"),
    include_bytes!("golden/v69_event_health.bin"),
    include_bytes!("golden/v69_event_death.bin"),
    include_bytes!("golden/v69_action_loot.bin"),
    include_bytes!("golden/v69_event_bag_dropped.bin"),
    include_bytes!("golden/v69_event_bag_sync.bin"),
    include_bytes!("golden/v69_event_bag_removed.bin"),
    include_bytes!("golden/v69_event_struct_hit_piece.bin"),
    include_bytes!("golden/v69_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v69_event_vitals.bin"),
    include_bytes!("golden/v69_event_consumed.bin"),
    include_bytes!("golden/v69_event_consume_refused.bin"),
    include_bytes!("golden/v69_action_consume.bin"),
    include_bytes!("golden/v69_event_drank.bin"),
    include_bytes!("golden/v69_action_drink.bin"),
    include_bytes!("golden/v69_event_respawn.bin"),
    include_bytes!("golden/v69_action_respawn.bin"),
    include_bytes!("golden/v69_action_move.bin"),
    include_bytes!("golden/v69_event_moved.bin"),
    include_bytes!("golden/v69_event_move_refused.bin"),
    include_bytes!("golden/v69_action_move_box.bin"),
    include_bytes!("golden/v69_action_container.bin"),
    include_bytes!("golden/v69_action_container_close.bin"),
    include_bytes!("golden/v69_event_cont_sync.bin"),
    include_bytes!("golden/v69_event_cont_close.bin"),
    include_bytes!("golden/v69_action_repair_piece.bin"),
    include_bytes!("golden/v69_action_repair_deploy.bin"),
    include_bytes!("golden/v69_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v69_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v69_action_throw_piece.bin"),
    include_bytes!("golden/v69_action_throw_deploy.bin"),
    include_bytes!("golden/v69_event_charge_placed_piece.bin"),
    include_bytes!("golden/v69_event_charge_placed_deploy.bin"),
    include_bytes!("golden/v69_challenge.bin"),
    include_bytes!("golden/v69_auth.bin"),
    include_bytes!("golden/v69_event_oven_lit.bin"),
    include_bytes!("golden/v69_event_oven_out.bin"),
    include_bytes!("golden/v69_event_knock.bin"),
    include_bytes!("golden/v69_event_auth.bin"),
    include_bytes!("golden/v69_action_access_crew.bin"),
    include_bytes!("golden/v69_action_demolish.bin"),
    include_bytes!("golden/v69_event_shot.bin"),
    include_bytes!("golden/v69_action_container_world.bin"),
    include_bytes!("golden/v69_action_move_world.bin"),
    include_bytes!("golden/v69_event_cont_sync_world.bin"),
    include_bytes!("golden/v69_action_unlock.bin"),
    include_bytes!("golden/v69_event_research_rows.bin"),
    include_bytes!("golden/v69_event_research.bin"),
    include_bytes!("golden/v69_event_research_refused.bin"),
    include_bytes!("golden/v69_event_known.bin"),
    include_bytes!("golden/v69_action_research.bin"),
    include_bytes!("golden/v69_event_gather_refused.bin"),
    include_bytes!("golden/v69_event_bags.bin"),
    include_bytes!("golden/v69_event_impact.bin"),
    include_bytes!("golden/v69_event_swing.bin"),
    include_bytes!("golden/v69_action_container_wear.bin"),
    include_bytes!("golden/v69_action_move_wear.bin"),
    include_bytes!("golden/v69_event_cont_sync_wear.bin"),
    include_bytes!("golden/v69_event_move_refused_wear.bin"),
    include_bytes!("golden/v69_action_pickup.bin"),
    include_bytes!("golden/v69_event_hurt.bin"),
    include_bytes!("golden/v69_action_reload.bin"),
    include_bytes!("golden/v69_event_reload.bin"),
    include_bytes!("golden/v69_event_reload_refused.bin"),
    include_bytes!("golden/v69_event_wounded.bin"),
    include_bytes!("golden/v69_event_recovered.bin"),
    include_bytes!("golden/v69_event_gitem_sync.bin"),
    include_bytes!("golden/v69_action_assist.bin"),
    include_bytes!("golden/v69_event_assist.bin"),
    include_bytes!("golden/v69_action_rotate.bin"),
];
...
/// Dispatch fixture `$i` and record that it was dispatched.
///
/// **The recording is the whole point.** `golden_action(GOLDEN[n],
/// FIXTURES[n])` written out by hand is a line that can simply be
/// missing, and a missing line looks like nothing at all — which is how
/// the four v51 wear goldens sat in the manifest unchecked. Routing every
/// dispatcher through one marker turns "did anybody look at this fixture"
/// into an assertion instead of a reading of the ladder.
macro_rules! g {
    ($seen:ident, $f:ident, $i:expr) => {{
        $seen[$i] = true;
        $f(GOLDEN[$i], FIXTURES[$i]);
    }};
}

/// `g!` for the two dispatchers that take the decoded payload as well —
/// the input and snapshot lanes, which compare against a constructed
/// case rather than re-encoding from the fixture's own bytes.
macro_rules! gp {
    ($seen:ident, $f:ident, $case:expr, $i:expr) => {{
        $seen[$i] = true;
        $f($case, GOLDEN[$i], FIXTURES[$i]);
    }};
}

#[test]
fn test_protocol_golden() {
    // Which fixtures the ladder below actually reached. Hand-written
    // dispatch lines can simply be absent, and an absent line looks like
    // nothing — see the coverage loop at the end for the four that were.
    let mut seen = [false; FIXTURES.len()];
    gp!(seen, golden_input, &input_acks_only(), 0);
    gp!(seen, golden_input, &input_full(), 1);
    gp!(seen, golden_snapshot, &snapshot_keyframe(), 2);
    gp!(seen, golden_snapshot, &snapshot_delta(), 3);
    gp!(seen, golden_snapshot, &snapshot_cap(), 4);
    g!(seen, golden_stream, 5);
    g!(seen, golden_stream, 6);
    g!(seen, golden_stream, 7);
    for i in 8..19 {
        g!(seen, golden_event, i);
    }
    g!(seen, golden_action, 19);
    g!(seen, golden_action, 20);
    g!(seen, golden_action, 21);
    for i in 22..26 {
        g!(seen, golden_event, i);
    }
    g!(seen, golden_action, 26);
    g!(seen, golden_action, 27);
    for i in 28..35 {
        g!(seen, golden_event, i);
    }
    g!(seen, golden_action, 35);
    g!(seen, golden_action, 36);
    g!(seen, golden_event, 37);
    g!(seen, golden_action, 38);
    g!(seen, golden_chat, 39);
    for i in 40..44 {
        g!(seen, golden_event, i);
    }
    g!(seen, golden_action, 44);
    for i in 45..53 {
        g!(seen, golden_event, i);
    }
    g!(seen, golden_action, 53);
    g!(seen, golden_event, 54);
    g!(seen, golden_action, 55);
    g!(seen, golden_event, 56);
    g!(seen, golden_action, 57);
    g!(seen, golden_action, 58);
    g!(seen, golden_event, 59);
    g!(seen, golden_event, 60);
    g!(seen, golden_action, 61);
    g!(seen, golden_action, 62);
    g!(seen, golden_action, 63);
    g!(seen, golden_event, 64);
    g!(seen, golden_event, 65);
    g!(seen, golden_action, 66);
    g!(seen, golden_action, 67);
    g!(seen, golden_event, 68);
    g!(seen, golden_event, 69);
    g!(seen, golden_action, 70);
    g!(seen, golden_action, 71);
    g!(seen, golden_event, 72);
    g!(seen, golden_event, 73);
    ...
    g!(seen, golden_action, 83);
    g!(seen, golden_action, 84);
    g!(seen, golden_event, 85);
    ...
    g!(seen, golden_action, 91);
    // The gather refusal (v42) — item durability's wire window.
    g!(seen, golden_event, 92);
    // Bag choice v0 (v43): the own-fact bag list.
    g!(seen, golden_event, 93);
    // Surface marks v0 (v44): where an arrow stopped, and on what.
    g!(seen, golden_event, 94);
    g!(seen, golden_event, 95);
    // Armor v1 (v51): the four wear fixtures. **They were in the manifest
    // and nothing dispatched them** — added to `FIXTURES` and `GOLDEN`
    // together, so the length assert below was satisfied and the ladder
    // simply stopped at 95. Found by the coverage loop this pass added.
    g!(seen, golden_action, 96);
    g!(seen, golden_action, 97);
    g!(seen, golden_event, 98);
    g!(seen, golden_event, 99);
    // Arrow recovery v1 (v53): the pickup verb.
    g!(seen, golden_action, 100);
    g!(seen, golden_event, 101);
    // Reload v1 (v59): the verb and its two events.
    g!(seen, golden_action, 102);
    g!(seen, golden_event, 103);
    g!(seen, golden_event, 104);
    // Wounded v0 (v63): the fall and the getting up.
    g!(seen, golden_event, 105);
    g!(seen, golden_event, 106);
    g!(seen, golden_event, 107);
    ...
    // miss quietly — but a fixture added to BOTH arrays and never
    // dispatched keeps the lengths equal, which is exactly how the four
    // wear goldens went unchecked from v51 to v53. A count is a claim
    // about the manifest; this is the claim about the ladder.
    for (i, hit) in seen.iter().enumerate() {
        assert!(
            hit,
            "fixture {i} ({}) is in the manifest and no line above dispatched it",
            FIXTURES[i]
        );
    }
}
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v68_action_place.bin" => {
            let (row, cx, cz, level, loc, freehand, plate) = action_place();
            assert_eq!(
                decode_action(fixture).unwrap(),
                ActionMsg::Place {
                    row,
        ...
        "v68_action_rotate.bin" => {
            let (cx, cz, level, loc) = protocol::goldens::action_rotate();
            assert_eq!(
                decode_action(fixture).unwrap(),
                ActionMsg::Rotate { cx, cz, level, loc },
                "{name}: decode mismatch"
            );
            protocol::encode_action_rotate(cx, cz, level, loc, &mut buf).unwrap()
        }
        "v68_action_demolish.bin" => {
        ...
        "v68_action_pickup.bin" => {
            assert_eq!(
                decode_action(fixture).unwrap(),
                ActionMsg::Pickup,
                "{name}: decode mismatch"
            );
            encode_action_pickup(&mut buf).unwrap()
        }
        "v68_action_consume.bin" => {
        ...
        "v68_action_assist.bin" => {
            assert_eq!(
                decode_action(fixture).unwrap(),
                ActionMsg::Assist { target: 0x12345678 }
            );
            protocol::encode_action_assist(0x12345678, &mut buf).unwrap()
        }
        "v68_action_reload.bin" => {
            assert_eq!(
                decode_action(fixture).unwrap(),
                ActionMsg::Reload,
                "{name}: decode mismatch"
        ...
        "v68_action_move_box.bin" | "v68_action_move_world.bin" | "v68_action_move_wear.bin" => {
            let (cont, from_kind, from_slot, to_kind, to_slot, count) = match name {
                "v68_action_move_box.bin" => action_move_box(),
                "v68_action_move_world.bin" => action_move_world(),
                _ => action_move_wear(),
            };
            assert_eq!(
                decode_action(fixture).unwrap(),
        ...
        "v68_action_repair_piece.bin" | "v68_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v68_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v68_action_throw_piece.bin" | "v68_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v68_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        "v68_action_container.bin"
        | "v68_action_container_close.bin"
        | "v68_action_container_world.bin"
        | "v68_action_container_wear.bin" => {
            let (kind, cont) = match name {
                "v68_action_container.bin" => action_container(),
                "v68_action_container_world.bin" => action_container_world(),
                "v68_action_container_wear.bin" => action_container_wear(),
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v68_event_research_refused.bin" => {
        ...
        "v68_event_reload.bin" => {
            ...
            encode_event_reload(loaded, ceiling, took, &mut buf).unwrap()
        }
        "v68_event_reload_refused.bin" => {
            let (item, reason, loaded, ceiling) = event_reload_refused();
            assert_eq!(
                decode_event(fixture).unwrap(),
            ...
            encode_event_reload_refused(item, reason, loaded, ceiling, &mut buf).unwrap()
        }
        "v68_event_gather_refused.bin" => {
        ...
        "v68_event_slot_harvested.bin" | "v68_event_slot_respawned.bin" => {
            let harvested = name == "v68_event_slot_harvested.bin";
            ...
            match decode_event(fixture).unwrap() {
                EventMsg::Catalog {
                    ...
                    for i in 0..count as usize {
                        ...
                        // Field by field rather than one struct compare, so
                        // a swapped pair names which column moved instead
                        // of printing two structs to diff by eye.
                        assert_eq!(
                            rows[i].cond_max,
                            cat.cond_max(i),
                        ...
                        assert_eq!(
                            rows[i].armor_pct,
                            cat.armor_pct(i),
                            "{name}: armor reduction {i} mismatch (v52 column)"
                        );
                        assert_eq!(
                            rows[i].wear_slot,
                            cat.wear_slot(i),
        ...
        "v68_event_piece_removed.bin" | "v68_event_deploy_removed.bin" => {
            let piece = name == "v68_event_piece_removed.bin";
        ...
        "v68_event_wounded.bin" => {
            let (ticks, chance_pm) = event_wounded();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::Wounded { ticks, chance_pm },
                "{name}: decode mismatch"
            );
            encode_event_wounded(ticks, chance_pm, &mut buf).unwrap()
        }
        "v68_event_recovered.bin" => {
            let (chance_pm, hp) = event_recovered();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::Recovered { chance_pm, hp },
                "{name}: decode mismatch"
            );
            encode_event_recovered(chance_pm, hp, &mut buf).unwrap()
        }
        "v68_event_hurt.bin" => {
            let (sector, damage) = event_hurt();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::Hurt { sector, damage },
                "{name}: decode mismatch"
            );
            encode_event_hurt(sector, damage, &mut buf).unwrap()
        }
        "v68_event_hit.bin" => {
            let (victim, part, damage) = event_hit();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::Hit {
                    victim,
            ...
            encode_event_hit(victim, part, damage, &mut buf).unwrap()
        }
        "v68_event_health.bin" => {
        ...
        "v68_event_move_refused.bin" | "v68_event_move_refused_wear.bin" => {
            let (reason, from_kind, from_slot, to_kind, to_slot) =
                if name == "v68_event_move_refused.bin" {
                    event_move_refused()
                } else {
                    event_move_refused_wear()
                };
            assert_eq!(
                decode_event(fixture).unwrap(),
        ...
        "v68_event_assist.bin" => {
            ...
            protocol::encode_event_assist(0x10203040, 0x12345678, 83, &mut buf).unwrap()
        }
        "v68_event_gitem_sync.bin" => {
            let (reset, recs) = event_gitem_sync();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::GItemSync {
                    reset,
                    recs,
                    count: GITEM_SYNC_BATCH as u8,
                },
                "the loose-stack batch did not round-trip"
            );
            encode_event_gitem_sync(reset, &recs, &mut buf).unwrap()
        }
        "v68_event_bag_sync.bin" => {
        ...
        n @ ("v68_event_struct_hit_piece.bin" | "v68_event_struct_hit_deploy.bin") => {
        ...
        "v68_event_cont_sync.bin" | "v68_event_cont_sync_world.bin" => {
            let (kind, cont, reset, rows) = if name == "v68_event_cont_sync.bin" {
                event_cont_sync()
            } else {
        ...
        // Its own arm rather than a third name on the one above, because
        // a wear container is `WEAR_SLOTS` wide and the two branches of
        // that `if` have to be one array type. Widening the fixture to
        // three rows to share the arm would have pinned a slot index the
        // sim refuses.
        "v68_event_cont_sync_wear.bin" => {
            let (kind, cont, reset, rows) = event_cont_sync_wear();
            let mut slots = [InvSlot::default(); CONT_SYNC_BATCH];
            slots[..rows.len()].copy_from_slice(&rows);
            assert_eq!(
                decode_event(fixture).unwrap(),
        ...
        "v68_event_piece_repaired_piece.bin" | "v68_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v68_event_piece_repaired_piece.bin" {
        ...
        "v68_event_charge_placed_piece.bin" | "v68_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v68_event_charge_placed_piece.bin" {
        ...
        "v68_event_oven_lit.bin" | "v68_event_oven_out.bin" => {
            let (cx, cz, level, lit, by) = if name == "v68_event_oven_lit.bin" {
                event_oven_lit()
            } else {
                event_oven_out()
            };
...
fn test_input_sel_domain_is_enforced() {
    ...
    // sel is the last 3 bits of the one frame (header: kind + ack:16 +
    // ack_bits:32 + playout:4 + frame_count:4, then first_seq:16 and 48
    // frame bits before it; the writer is LSB-first within each byte):
    // force all three high — sel 7 — and decode must refuse.
    ...
    // and v61 shrank `first_client_tick:32` to `playout_ticks:4`, which
    // moved it again.
    let sel_bit = KIND_BITS as usize + 16 + 32 + 4 + 4 + 16 + 48;
    for b in 0..3 {
        let bit = sel_bit + b;
        buf[bit / 8] |= 1 << (bit % 8);
    }
