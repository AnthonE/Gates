...
use protocol::goldens::{
    ...
    action_respawn, action_upgrade, action_use, chat, event_bag_dropped, event_bag_removed,
    event_bag_sync, event_build_refused, event_catalog, event_chat, event_consume_refused,
    ...
    event_move_refused, event_moved, event_piece_defs, event_piece_placed, event_piece_sync,
