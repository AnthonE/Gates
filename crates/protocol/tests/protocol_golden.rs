...
const GOLDEN: [&[u8]; 83] = [
    ...
    include_bytes!("golden/v31_event_shot.bin"),
];
...
fn test_protocol_golden() {
    ...
    // The arrow becomes visible (v31): one broadcast carrying the shooter,
    ...
    assert_eq!(GOLDEN.len(), 83, "a new fixture must be dispatched above");
}
