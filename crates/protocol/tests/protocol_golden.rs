...
const GOLDEN: [&[u8]; 111] = [
    include_bytes!("golden/v68_input_acks_only.bin"),
    include_bytes!("golden/v68_input_full.bin"),
    include_bytes!("golden/v68_snapshot_keyframe.bin"),
    include_bytes!("golden/v68_snapshot_delta.bin"),
    include_bytes!("golden/v68_snapshot_cap.bin"),
    include_bytes!("golden/v68_hello.bin"),
    include_bytes!("golden/v68_welcome.bin"),
    include_bytes!("golden/v68_refuse_full.bin"),
    include_bytes!("golden/v68_event_gather.bin"),
    include_bytes!("golden/v68_event_inv.bin"),
    include_bytes!("golden/v68_event_slot_harvested.bin"),
    include_bytes!("golden/v68_event_slot_respawned.bin"),
    include_bytes!("golden/v68_event_slot_sync.bin"),
    include_bytes!("golden/v68_event_catalog.bin"),
    include_bytes!("golden/v68_event_weak_mark.bin"),
    include_bytes!("golden/v68_event_craft_q.bin"),
    include_bytes!("golden/v68_event_craft_done.bin"),
    include_bytes!("golden/v68_event_craft_refused.bin"),
    include_bytes!("golden/v68_event_recipes.bin"),
    include_bytes!("golden/v68_action_craft.bin"),
    include_bytes!("golden/v68_action_cancel.bin"),
    include_bytes!("golden/v68_action_place.bin"),
    include_bytes!("golden/v68_event_piece_placed.bin"),
    include_bytes!("golden/v68_event_piece_sync.bin"),
    include_bytes!("golden/v68_event_build_refused.bin"),
    include_bytes!("golden/v68_event_piece_defs.bin"),
    include_bytes!("golden/v68_action_deploy.bin"),
    include_bytes!("golden/v68_action_feed.bin"),
    include_bytes!("golden/v68_event_deploy_placed.bin"),
    include_bytes!("golden/v68_event_deploy_sync.bin"),
    include_bytes!("golden/v68_event_deploy_refused.bin"),
    include_bytes!("golden/v68_event_deploy_defs.bin"),
    include_bytes!("golden/v68_event_piece_removed.bin"),
    include_bytes!("golden/v68_event_deploy_removed.bin"),
    include_bytes!("golden/v68_event_stock.bin"),
    include_bytes!("golden/v68_action_use.bin"),
    include_bytes!("golden/v68_action_access.bin"),
    include_bytes!("golden/v68_event_door.bin"),
    include_bytes!("golden/v68_action_upgrade.bin"),
    include_bytes!("golden/v68_chat.bin"),
    include_bytes!("golden/v68_event_chat.bin"),
    include_bytes!("golden/v68_event_hit.bin"),
    include_bytes!("golden/v68_event_health.bin"),
    include_bytes!("golden/v68_event_death.bin"),
    include_bytes!("golden/v68_action_loot.bin"),
    include_bytes!("golden/v68_event_bag_dropped.bin"),
    include_bytes!("golden/v68_event_bag_sync.bin"),
    include_bytes!("golden/v68_event_bag_removed.bin"),
    include_bytes!("golden/v68_event_struct_hit_piece.bin"),
    include_bytes!("golden/v68_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v68_event_vitals.bin"),
    include_bytes!("golden/v68_event_consumed.bin"),
    include_bytes!("golden/v68_event_consume_refused.bin"),
    include_bytes!("golden/v68_action_consume.bin"),
    include_bytes!("golden/v68_event_drank.bin"),
    include_bytes!("golden/v68_action_drink.bin"),
    include_bytes!("golden/v68_event_respawn.bin"),
    include_bytes!("golden/v68_action_respawn.bin"),
    include_bytes!("golden/v68_action_move.bin"),
    include_bytes!("golden/v68_event_moved.bin"),
    include_bytes!("golden/v68_event_move_refused.bin"),
    include_bytes!("golden/v68_action_move_box.bin"),
    include_bytes!("golden/v68_action_container.bin"),
    include_bytes!("golden/v68_action_container_close.bin"),
    include_bytes!("golden/v68_event_cont_sync.bin"),
    include_bytes!("golden/v68_event_cont_close.bin"),
    include_bytes!("golden/v68_action_repair_piece.bin"),
    include_bytes!("golden/v68_action_repair_deploy.bin"),
    include_bytes!("golden/v68_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v68_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v68_action_throw_piece.bin"),
    include_bytes!("golden/v68_action_throw_deploy.bin"),
    include_bytes!("golden/v68_event_charge_placed_piece.bin"),
    include_bytes!("golden/v68_event_charge_placed_deploy.bin"),
    include_bytes!("golden/v68_challenge.bin"),
    include_bytes!("golden/v68_auth.bin"),
    include_bytes!("golden/v68_event_oven_lit.bin"),
    include_bytes!("golden/v68_event_oven_out.bin"),
    include_bytes!("golden/v68_event_knock.bin"),
    include_bytes!("golden/v68_event_auth.bin"),
    include_bytes!("golden/v68_action_access_crew.bin"),
    include_bytes!("golden/v68_action_demolish.bin"),
    include_bytes!("golden/v68_event_shot.bin"),
    include_bytes!("golden/v68_action_container_world.bin"),
    include_bytes!("golden/v68_action_move_world.bin"),
    include_bytes!("golden/v68_event_cont_sync_world.bin"),
    include_bytes!("golden/v68_action_unlock.bin"),
    include_bytes!("golden/v68_event_research_rows.bin"),
    include_bytes!("golden/v68_event_research.bin"),
    include_bytes!("golden/v68_event_research_refused.bin"),
    include_bytes!("golden/v68_event_known.bin"),
    include_bytes!("golden/v68_action_research.bin"),
    include_bytes!("golden/v68_event_gather_refused.bin"),
    include_bytes!("golden/v68_event_bags.bin"),
    include_bytes!("golden/v68_event_impact.bin"),
    include_bytes!("golden/v68_event_swing.bin"),
    include_bytes!("golden/v68_action_container_wear.bin"),
    include_bytes!("golden/v68_action_move_wear.bin"),
    include_bytes!("golden/v68_event_cont_sync_wear.bin"),
    include_bytes!("golden/v68_event_move_refused_wear.bin"),
    include_bytes!("golden/v68_action_pickup.bin"),
    include_bytes!("golden/v68_event_hurt.bin"),
    include_bytes!("golden/v68_action_reload.bin"),
    include_bytes!("golden/v68_event_reload.bin"),
    include_bytes!("golden/v68_event_reload_refused.bin"),
    include_bytes!("golden/v68_event_wounded.bin"),
    include_bytes!("golden/v68_event_recovered.bin"),
    include_bytes!("golden/v68_event_gitem_sync.bin"),
    include_bytes!("golden/v68_action_assist.bin"),
    include_bytes!("golden/v68_event_assist.bin"),
    include_bytes!("golden/v68_action_rotate.bin"),
];
