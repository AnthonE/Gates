...
use protocol::goldens::{
    ...
    action_throw_piece, action_upgrade, action_use, chat, event_bag_dropped, event_bag_removed,
    event_bag_sync, event_build_refused, event_catalog, event_charge_placed_deploy,
    event_charge_placed_piece, event_chat, event_consume_refused, event_consumed, event_cont_close,
    event_cont_sync, event_craft_done, event_craft_q, event_craft_refused, event_death,
    event_deploy_defs, event_deploy_placed, event_deploy_refused, event_deploy_sync, event_door,
    event_drank, event_gather, event_health, event_hit, event_inv, event_move_refused, event_moved,
    event_piece_defs, event_piece_placed, event_piece_repaired_deploy, event_piece_repaired_piece,
    event_piece_sync, event_recipes, event_removed, event_respawn, event_slot_change,
...
const GOLDEN: [&[u8]; 74] = [
    include_bytes!("golden/v24_input_acks_only.bin"),
    include_bytes!("golden/v24_input_full.bin"),
    include_bytes!("golden/v24_snapshot_keyframe.bin"),
    include_bytes!("golden/v24_snapshot_delta.bin"),
    include_bytes!("golden/v24_snapshot_cap.bin"),
    include_bytes!("golden/v24_hello.bin"),
    include_bytes!("golden/v24_welcome.bin"),
    include_bytes!("golden/v24_refuse_full.bin"),
    include_bytes!("golden/v24_event_gather.bin"),
    include_bytes!("golden/v24_event_inv.bin"),
    include_bytes!("golden/v24_event_slot_harvested.bin"),
    include_bytes!("golden/v24_event_slot_respawned.bin"),
    include_bytes!("golden/v24_event_slot_sync.bin"),
    include_bytes!("golden/v24_event_catalog.bin"),
    include_bytes!("golden/v24_event_weak_mark.bin"),
    include_bytes!("golden/v24_event_craft_q.bin"),
    include_bytes!("golden/v24_event_craft_done.bin"),
    include_bytes!("golden/v24_event_craft_refused.bin"),
    include_bytes!("golden/v24_event_recipes.bin"),
    include_bytes!("golden/v24_action_craft.bin"),
    include_bytes!("golden/v24_action_cancel.bin"),
    include_bytes!("golden/v24_action_place.bin"),
    include_bytes!("golden/v24_event_piece_placed.bin"),
    include_bytes!("golden/v24_event_piece_sync.bin"),
    include_bytes!("golden/v24_event_build_refused.bin"),
    include_bytes!("golden/v24_event_piece_defs.bin"),
    include_bytes!("golden/v24_action_deploy.bin"),
    include_bytes!("golden/v24_action_feed.bin"),
    include_bytes!("golden/v24_event_deploy_placed.bin"),
    include_bytes!("golden/v24_event_deploy_sync.bin"),
    include_bytes!("golden/v24_event_deploy_refused.bin"),
    include_bytes!("golden/v24_event_deploy_defs.bin"),
    include_bytes!("golden/v24_event_piece_removed.bin"),
    include_bytes!("golden/v24_event_deploy_removed.bin"),
    include_bytes!("golden/v24_event_stock.bin"),
    include_bytes!("golden/v24_action_use.bin"),
    include_bytes!("golden/v24_action_lock.bin"),
    include_bytes!("golden/v24_event_door.bin"),
    include_bytes!("golden/v24_action_upgrade.bin"),
    include_bytes!("golden/v24_chat.bin"),
    include_bytes!("golden/v24_event_chat.bin"),
    include_bytes!("golden/v24_event_hit.bin"),
    include_bytes!("golden/v24_event_health.bin"),
    include_bytes!("golden/v24_event_death.bin"),
    include_bytes!("golden/v24_action_loot.bin"),
    include_bytes!("golden/v24_event_bag_dropped.bin"),
    include_bytes!("golden/v24_event_bag_sync.bin"),
    include_bytes!("golden/v24_event_bag_removed.bin"),
    include_bytes!("golden/v24_event_struct_hit_piece.bin"),
    include_bytes!("golden/v24_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v24_event_vitals.bin"),
    include_bytes!("golden/v24_event_consumed.bin"),
    include_bytes!("golden/v24_event_consume_refused.bin"),
    include_bytes!("golden/v24_action_consume.bin"),
    include_bytes!("golden/v24_event_drank.bin"),
    include_bytes!("golden/v24_action_drink.bin"),
    include_bytes!("golden/v24_event_respawn.bin"),
    include_bytes!("golden/v24_action_respawn.bin"),
    include_bytes!("golden/v24_action_move.bin"),
    include_bytes!("golden/v24_event_moved.bin"),
    include_bytes!("golden/v24_event_move_refused.bin"),
    include_bytes!("golden/v24_action_move_box.bin"),
    include_bytes!("golden/v24_action_container.bin"),
    include_bytes!("golden/v24_action_container_close.bin"),
    include_bytes!("golden/v24_event_cont_sync.bin"),
    include_bytes!("golden/v24_event_cont_close.bin"),
    include_bytes!("golden/v24_action_repair_piece.bin"),
    include_bytes!("golden/v24_action_repair_deploy.bin"),
    include_bytes!("golden/v24_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v24_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v24_action_throw_piece.bin"),
    include_bytes!("golden/v24_action_throw_deploy.bin"),
    include_bytes!("golden/v24_event_charge_placed_piece.bin"),
    include_bytes!("golden/v24_event_charge_placed_deploy.bin"),
];
...
fn test_protocol_golden() {
    ...
    assert_eq!(GOLDEN.len(), 74, "a new fixture must be dispatched above");
}
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v24_action_repair_piece.bin" | "v24_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v24_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v24_action_throw_piece.bin" | "v24_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v24_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        "v24_action_container.bin" | "v24_action_container_close.bin" => {
            let (kind, cont) = if name == "v24_action_container.bin" {
                action_container()
            } else {
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v24_event_slot_harvested.bin" | "v24_event_slot_respawned.bin" => {
            let harvested = name == "v24_event_slot_harvested.bin";
        ...
        "v24_event_piece_removed.bin" | "v24_event_deploy_removed.bin" => {
            let piece = name == "v24_event_piece_removed.bin";
        ...
        n @ ("v24_event_struct_hit_piece.bin" | "v24_event_struct_hit_deploy.bin") => {
        ...
        "v24_event_piece_repaired_piece.bin" | "v24_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v24_event_piece_repaired_piece.bin" {
        ...
        "v24_event_charge_placed_piece.bin" | "v24_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v24_event_charge_placed_piece.bin" {
