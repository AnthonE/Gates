...
use protocol::goldens::{
    ...
    action_container_close, action_craft, action_demolish, action_deploy, action_feed, action_move,
    action_move_box, action_place, action_repair_deploy, action_repair_piece, action_respawn,
...
const GOLDEN: [&[u8]; 82] = [
    include_bytes!("golden/v31_input_acks_only.bin"),
    include_bytes!("golden/v31_input_full.bin"),
    include_bytes!("golden/v31_snapshot_keyframe.bin"),
    include_bytes!("golden/v31_snapshot_delta.bin"),
    include_bytes!("golden/v31_snapshot_cap.bin"),
    include_bytes!("golden/v31_hello.bin"),
    include_bytes!("golden/v31_welcome.bin"),
    include_bytes!("golden/v31_refuse_full.bin"),
    include_bytes!("golden/v31_event_gather.bin"),
    include_bytes!("golden/v31_event_inv.bin"),
    include_bytes!("golden/v31_event_slot_harvested.bin"),
    include_bytes!("golden/v31_event_slot_respawned.bin"),
    include_bytes!("golden/v31_event_slot_sync.bin"),
    include_bytes!("golden/v31_event_catalog.bin"),
    include_bytes!("golden/v31_event_weak_mark.bin"),
    include_bytes!("golden/v31_event_craft_q.bin"),
    include_bytes!("golden/v31_event_craft_done.bin"),
    include_bytes!("golden/v31_event_craft_refused.bin"),
    include_bytes!("golden/v31_event_recipes.bin"),
    include_bytes!("golden/v31_action_craft.bin"),
    include_bytes!("golden/v31_action_cancel.bin"),
    include_bytes!("golden/v31_action_place.bin"),
    include_bytes!("golden/v31_event_piece_placed.bin"),
    include_bytes!("golden/v31_event_piece_sync.bin"),
    include_bytes!("golden/v31_event_build_refused.bin"),
    include_bytes!("golden/v31_event_piece_defs.bin"),
    include_bytes!("golden/v31_action_deploy.bin"),
    include_bytes!("golden/v31_action_feed.bin"),
    include_bytes!("golden/v31_event_deploy_placed.bin"),
    include_bytes!("golden/v31_event_deploy_sync.bin"),
    include_bytes!("golden/v31_event_deploy_refused.bin"),
    include_bytes!("golden/v31_event_deploy_defs.bin"),
    include_bytes!("golden/v31_event_piece_removed.bin"),
    include_bytes!("golden/v31_event_deploy_removed.bin"),
    include_bytes!("golden/v31_event_stock.bin"),
    include_bytes!("golden/v31_action_use.bin"),
    include_bytes!("golden/v31_action_access.bin"),
    include_bytes!("golden/v31_event_door.bin"),
    include_bytes!("golden/v31_action_upgrade.bin"),
    include_bytes!("golden/v31_chat.bin"),
    include_bytes!("golden/v31_event_chat.bin"),
    include_bytes!("golden/v31_event_hit.bin"),
    include_bytes!("golden/v31_event_health.bin"),
    include_bytes!("golden/v31_event_death.bin"),
    include_bytes!("golden/v31_action_loot.bin"),
    include_bytes!("golden/v31_event_bag_dropped.bin"),
    include_bytes!("golden/v31_event_bag_sync.bin"),
    include_bytes!("golden/v31_event_bag_removed.bin"),
    include_bytes!("golden/v31_event_struct_hit_piece.bin"),
    include_bytes!("golden/v31_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v31_event_vitals.bin"),
    include_bytes!("golden/v31_event_consumed.bin"),
    include_bytes!("golden/v31_event_consume_refused.bin"),
    include_bytes!("golden/v31_action_consume.bin"),
    include_bytes!("golden/v31_event_drank.bin"),
    include_bytes!("golden/v31_action_drink.bin"),
    include_bytes!("golden/v31_event_respawn.bin"),
    include_bytes!("golden/v31_action_respawn.bin"),
    include_bytes!("golden/v31_action_move.bin"),
    include_bytes!("golden/v31_event_moved.bin"),
    include_bytes!("golden/v31_event_move_refused.bin"),
    include_bytes!("golden/v31_action_move_box.bin"),
    include_bytes!("golden/v31_action_container.bin"),
    include_bytes!("golden/v31_action_container_close.bin"),
    include_bytes!("golden/v31_event_cont_sync.bin"),
    include_bytes!("golden/v31_event_cont_close.bin"),
    include_bytes!("golden/v31_action_repair_piece.bin"),
    include_bytes!("golden/v31_action_repair_deploy.bin"),
    include_bytes!("golden/v31_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v31_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v31_action_throw_piece.bin"),
    include_bytes!("golden/v31_action_throw_deploy.bin"),
    include_bytes!("golden/v31_event_charge_placed_piece.bin"),
    include_bytes!("golden/v31_event_charge_placed_deploy.bin"),
    include_bytes!("golden/v31_challenge.bin"),
    include_bytes!("golden/v31_auth.bin"),
    include_bytes!("golden/v31_event_oven_lit.bin"),
    include_bytes!("golden/v31_event_oven_out.bin"),
    include_bytes!("golden/v31_event_knock.bin"),
    include_bytes!("golden/v31_event_auth.bin"),
    include_bytes!("golden/v31_action_access_crew.bin"),
    include_bytes!("golden/v31_action_demolish.bin"),
];
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v31_action_repair_piece.bin" | "v31_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v31_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v31_action_throw_piece.bin" | "v31_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v31_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        "v31_action_container.bin" | "v31_action_container_close.bin" => {
            let (kind, cont) = if name == "v31_action_container.bin" {
                action_container()
            } else {
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v31_event_slot_harvested.bin" | "v31_event_slot_respawned.bin" => {
            let harvested = name == "v31_event_slot_harvested.bin";
        ...
        "v31_event_piece_removed.bin" | "v31_event_deploy_removed.bin" => {
            let piece = name == "v31_event_piece_removed.bin";
        ...
        n @ ("v31_event_struct_hit_piece.bin" | "v31_event_struct_hit_deploy.bin") => {
        ...
        "v31_event_piece_repaired_piece.bin" | "v31_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v31_event_piece_repaired_piece.bin" {
        ...
        "v31_event_charge_placed_piece.bin" | "v31_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v31_event_charge_placed_piece.bin" {
        ...
        "v31_event_oven_lit.bin" | "v31_event_oven_out.bin" => {
            let (cx, cz, level, lit, by) = if name == "v31_event_oven_lit.bin" {
                event_oven_lit()
            } else {
                event_oven_out()
            };
...
fn test_upgrade_material_domain_is_enforced() {
    ...
    // payload bits (KIND_BITS kind + 5 subtype + 10 + 10 + 3 + 2 address bits
    // before it, LSB-first within each byte). The subtype width moved
    // 3 → 4 in wire v12 (the loot action was the ninth) and 4 → 5 in v30
    // (demolish was the seventeenth).
    let len = encode_action_upgrade(cx, cz, level, loc, 1, &mut buf).unwrap();
    assert!(matches!(
        decode_action(&buf[..len]).unwrap(),
        ActionMsg::Upgrade { material: 1, .. }
    ));
    let mat_bit = KIND_BITS as usize + 5 + 10 + 10 + 3 + 2;
    for b in 0..2 {
        let bit = mat_bit + b;
        buf[bit / 8] |= 1 << (bit % 8);
    }
