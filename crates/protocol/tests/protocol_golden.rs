...
use protocol::goldens::{
    ...
    event_reload, event_reload_refused,
...
use protocol::{
    ...
    encode_action_reload,
    encode_action_loot, encode_action_move, encode_action_pickup, encode_action_place,
    encode_action_repair, encode_action_research, encode_action_respawn, encode_action_throw,
    encode_action_unlock, encode_action_upgrade, encode_action_use, encode_auth, encode_challenge,
    encode_chat, encode_event_auth, encode_event_bag_dropped, encode_event_bag_removed,
