...
//! corruption never panics it. Changed the wire on purpose? Bump
//! `PROTO_VER` and run `cargo run -p protocol --example gen_goldens`.
...
const GOLDEN: [&[u8]; 121] = [
    ...
    include_bytes!("golden/snapshot_delta.bin"),
    include_bytes!("golden/snapshot_cap.bin"),
    include_bytes!("golden/hello.bin"),
    include_bytes!("golden/welcome.bin"),
    include_bytes!("golden/refuse_full.bin"),
    include_bytes!("golden/event_gather.bin"),
    include_bytes!("golden/event_inv.bin"),
    include_bytes!("golden/event_slot_harvested.bin"),
    include_bytes!("golden/event_slot_respawned.bin"),
    include_bytes!("golden/event_slot_sync.bin"),
    include_bytes!("golden/event_catalog.bin"),
    include_bytes!("golden/event_weak_mark.bin"),
    include_bytes!("golden/event_craft_q.bin"),
    include_bytes!("golden/event_craft_done.bin"),
    include_bytes!("golden/event_craft_refused.bin"),
    include_bytes!("golden/event_recipes.bin"),
    include_bytes!("golden/action_craft.bin"),
    include_bytes!("golden/action_cancel.bin"),
    include_bytes!("golden/action_place.bin"),
    include_bytes!("golden/event_piece_placed.bin"),
    include_bytes!("golden/event_piece_sync.bin"),
    include_bytes!("golden/event_build_refused.bin"),
    include_bytes!("golden/event_piece_defs.bin"),
    include_bytes!("golden/action_deploy.bin"),
    include_bytes!("golden/action_feed.bin"),
    include_bytes!("golden/event_deploy_placed.bin"),
    include_bytes!("golden/event_deploy_sync.bin"),
    include_bytes!("golden/event_deploy_refused.bin"),
    include_bytes!("golden/event_deploy_defs.bin"),
    include_bytes!("golden/event_piece_removed.bin"),
    include_bytes!("golden/event_deploy_removed.bin"),
    include_bytes!("golden/event_stock.bin"),
    include_bytes!("golden/action_use.bin"),
    include_bytes!("golden/action_access.bin"),
    include_bytes!("golden/event_door.bin"),
    include_bytes!("golden/action_upgrade.bin"),
    include_bytes!("golden/chat.bin"),
    include_bytes!("golden/event_chat.bin"),
    include_bytes!("golden/event_hit.bin"),
    include_bytes!("golden/event_health.bin"),
    include_bytes!("golden/event_death.bin"),
    include_bytes!("golden/action_loot.bin"),
    include_bytes!("golden/event_bag_dropped.bin"),
    include_bytes!("golden/event_bag_sync.bin"),
    include_bytes!("golden/event_bag_removed.bin"),
    include_bytes!("golden/event_struct_hit_piece.bin"),
    include_bytes!("golden/event_struct_hit_deploy.bin"),
    include_bytes!("golden/event_vitals.bin"),
    include_bytes!("golden/event_consumed.bin"),
    include_bytes!("golden/event_consume_refused.bin"),
    include_bytes!("golden/action_consume.bin"),
    include_bytes!("golden/event_drank.bin"),
    include_bytes!("golden/action_drink.bin"),
    include_bytes!("golden/event_respawn.bin"),
    include_bytes!("golden/action_respawn.bin"),
    include_bytes!("golden/action_move.bin"),
    include_bytes!("golden/event_moved.bin"),
    include_bytes!("golden/event_move_refused.bin"),
    include_bytes!("golden/action_move_box.bin"),
    include_bytes!("golden/action_container.bin"),
    include_bytes!("golden/action_container_close.bin"),
    include_bytes!("golden/event_cont_sync.bin"),
    include_bytes!("golden/event_cont_close.bin"),
    include_bytes!("golden/action_repair_piece.bin"),
    include_bytes!("golden/action_repair_deploy.bin"),
    include_bytes!("golden/event_piece_repaired_piece.bin"),
    include_bytes!("golden/event_piece_repaired_deploy.bin"),
    include_bytes!("golden/action_throw_piece.bin"),
    include_bytes!("golden/action_throw_deploy.bin"),
    include_bytes!("golden/event_charge_placed_piece.bin"),
    include_bytes!("golden/event_charge_placed_deploy.bin"),
    include_bytes!("golden/challenge.bin"),
    include_bytes!("golden/auth.bin"),
    include_bytes!("golden/event_oven_lit.bin"),
    include_bytes!("golden/event_oven_out.bin"),
    include_bytes!("golden/event_knock.bin"),
    include_bytes!("golden/event_auth.bin"),
    include_bytes!("golden/action_access_crew.bin"),
    include_bytes!("golden/action_demolish.bin"),
    include_bytes!("golden/event_shot.bin"),
    include_bytes!("golden/action_container_world.bin"),
    include_bytes!("golden/action_move_world.bin"),
    include_bytes!("golden/event_cont_sync_world.bin"),
    include_bytes!("golden/action_unlock.bin"),
    include_bytes!("golden/event_research_rows.bin"),
    include_bytes!("golden/event_research.bin"),
    include_bytes!("golden/event_research_refused.bin"),
    include_bytes!("golden/event_known.bin"),
    include_bytes!("golden/action_research.bin"),
    include_bytes!("golden/event_gather_refused.bin"),
    include_bytes!("golden/event_bags.bin"),
    include_bytes!("golden/event_impact.bin"),
    include_bytes!("golden/event_swing.bin"),
    include_bytes!("golden/action_container_wear.bin"),
    include_bytes!("golden/action_move_wear.bin"),
    include_bytes!("golden/event_cont_sync_wear.bin"),
    include_bytes!("golden/event_move_refused_wear.bin"),
    include_bytes!("golden/action_pickup.bin"),
    include_bytes!("golden/event_hurt.bin"),
    include_bytes!("golden/action_reload.bin"),
    include_bytes!("golden/event_reload.bin"),
    include_bytes!("golden/event_reload_refused.bin"),
    include_bytes!("golden/event_wounded.bin"),
    include_bytes!("golden/event_recovered.bin"),
    include_bytes!("golden/event_gitem_sync.bin"),
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "action_move_box.bin" | "action_move_world.bin" | "action_move_wear.bin" => {
            let (cont, from_kind, from_slot, to_kind, to_slot, count) = match name {
                "action_move_box.bin" => action_move_box(),
                "action_move_world.bin" => action_move_world(),
                _ => action_move_wear(),
            };
            assert_eq!(
                decode_action(fixture).unwrap(),
        ...
        "action_repair_piece.bin" | "action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "action_throw_piece.bin" | "action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        | "action_container_wear.bin" => {
            let (kind, cont) = match name {
                "action_container.bin" => action_container(),
                "action_container_world.bin" => action_container_world(),
                "action_container_wear.bin" => action_container_wear(),
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "event_piece_removed.bin" | "event_deploy_removed.bin" => {
            let piece = name == "event_piece_removed.bin";
        ...
        "event_move_refused.bin" | "event_move_refused_wear.bin" => {
            let (reason, from_kind, from_slot, to_kind, to_slot) =
                if name == "event_move_refused.bin" {
                    event_move_refused()
                } else {
        ...
        n @ ("event_struct_hit_piece.bin" | "event_struct_hit_deploy.bin") => {
        ...
        "event_cont_sync.bin" | "event_cont_sync_world.bin" => {
            let (kind, cont, reset, rows) = if name == "event_cont_sync.bin" {
                event_cont_sync()
            } else {
        ...
        "event_piece_repaired_piece.bin" | "event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "event_piece_repaired_piece.bin" {
        ...
        "event_charge_placed_piece.bin" | "event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) = if name == "event_charge_placed_piece.bin"
            {
        ...
        "event_howl.bin" => {
            let mob = protocol::goldens::event_howl();
            assert_eq!(
                decode_event(fixture).unwrap(),
                EventMsg::Howl { mob },
                "{name}: decode mismatch"
...
///
/// By name rather than by index: `FIXTURES` is positional, so an index
/// re-points at another message the moment a name is inserted rather than
/// appended — and a lookup that finds nothing is one `unwrap_or` away from a
/// gate that checks nothing.
fn fixture_index(name: &str) -> usize {
    FIXTURES
        .iter()
        .position(|n| *n == name)
        .unwrap_or_else(|| panic!("no fixture named `{name}` — this gate is aimed at nothing"))
}
...
fn the_input_golden_fuzzes_the_whole_button_octet() {
    let dg = decode_input(GOLDEN[fixture_index("input_full.bin")]).expect("the fixture decodes");
...
fn the_piece_goldens_carry_a_live_plate() {
    ...
    match decode_event(GOLDEN[fixture_index("event_piece_placed.bin")])
    ...
    match decode_event(GOLDEN[fixture_index("event_piece_sync.bin")]).expect("piece sync decodes") {
...
fn the_loc_fuzz_covers_each_stores_whole_domain() {
    ...
    let mut seen = [false; 16];
    match decode_event(GOLDEN[fixture_index("event_deploy_sync.bin")]).expect("deploy sync decodes")
    {
