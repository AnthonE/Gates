...
use protocol::goldens::{
    ...
    action_repair_deploy, action_repair_piece, action_respawn, action_upgrade, action_use, chat,
    ...
    event_craft_done, event_craft_q, event_craft_refused, event_death, event_deploy_defs,
    event_deploy_placed, event_deploy_refused, event_deploy_sync, event_door, event_drank,
    event_gather, event_health, event_hit, event_inv, event_move_refused, event_moved,
...
const GOLDEN: [&[u8]; 70] = [
    include_bytes!("golden/v22_input_acks_only.bin"),
    include_bytes!("golden/v22_input_full.bin"),
    include_bytes!("golden/v22_snapshot_keyframe.bin"),
    include_bytes!("golden/v22_snapshot_delta.bin"),
    include_bytes!("golden/v22_snapshot_cap.bin"),
    include_bytes!("golden/v22_hello.bin"),
    include_bytes!("golden/v22_welcome.bin"),
    include_bytes!("golden/v22_refuse_full.bin"),
    include_bytes!("golden/v22_event_gather.bin"),
    include_bytes!("golden/v22_event_inv.bin"),
    include_bytes!("golden/v22_event_slot_harvested.bin"),
    include_bytes!("golden/v22_event_slot_respawned.bin"),
    include_bytes!("golden/v22_event_slot_sync.bin"),
    include_bytes!("golden/v22_event_catalog.bin"),
    include_bytes!("golden/v22_event_weak_mark.bin"),
    include_bytes!("golden/v22_event_craft_q.bin"),
    include_bytes!("golden/v22_event_craft_done.bin"),
    include_bytes!("golden/v22_event_craft_refused.bin"),
    include_bytes!("golden/v22_event_recipes.bin"),
    include_bytes!("golden/v22_action_craft.bin"),
    include_bytes!("golden/v22_action_cancel.bin"),
    include_bytes!("golden/v22_action_place.bin"),
    include_bytes!("golden/v22_event_piece_placed.bin"),
    include_bytes!("golden/v22_event_piece_sync.bin"),
    include_bytes!("golden/v22_event_build_refused.bin"),
    include_bytes!("golden/v22_event_piece_defs.bin"),
    include_bytes!("golden/v22_action_deploy.bin"),
    include_bytes!("golden/v22_action_feed.bin"),
    include_bytes!("golden/v22_event_deploy_placed.bin"),
    include_bytes!("golden/v22_event_deploy_sync.bin"),
    include_bytes!("golden/v22_event_deploy_refused.bin"),
    include_bytes!("golden/v22_event_deploy_defs.bin"),
    include_bytes!("golden/v22_event_piece_removed.bin"),
    include_bytes!("golden/v22_event_deploy_removed.bin"),
    include_bytes!("golden/v22_event_stock.bin"),
    include_bytes!("golden/v22_action_use.bin"),
    include_bytes!("golden/v22_action_lock.bin"),
    include_bytes!("golden/v22_event_door.bin"),
    include_bytes!("golden/v22_action_upgrade.bin"),
    include_bytes!("golden/v22_chat.bin"),
    include_bytes!("golden/v22_event_chat.bin"),
    include_bytes!("golden/v22_event_hit.bin"),
    include_bytes!("golden/v22_event_health.bin"),
    include_bytes!("golden/v22_event_death.bin"),
    include_bytes!("golden/v22_action_loot.bin"),
    include_bytes!("golden/v22_event_bag_dropped.bin"),
    include_bytes!("golden/v22_event_bag_sync.bin"),
    include_bytes!("golden/v22_event_bag_removed.bin"),
    include_bytes!("golden/v22_event_struct_hit_piece.bin"),
    include_bytes!("golden/v22_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v22_event_vitals.bin"),
    include_bytes!("golden/v22_event_consumed.bin"),
    include_bytes!("golden/v22_event_consume_refused.bin"),
    include_bytes!("golden/v22_action_consume.bin"),
    include_bytes!("golden/v22_event_drank.bin"),
    include_bytes!("golden/v22_action_drink.bin"),
    include_bytes!("golden/v22_event_respawn.bin"),
    include_bytes!("golden/v22_action_respawn.bin"),
    include_bytes!("golden/v22_action_move.bin"),
    include_bytes!("golden/v22_event_moved.bin"),
    include_bytes!("golden/v22_event_move_refused.bin"),
    include_bytes!("golden/v22_action_move_box.bin"),
    include_bytes!("golden/v22_action_container.bin"),
    include_bytes!("golden/v22_action_container_close.bin"),
    include_bytes!("golden/v22_event_cont_sync.bin"),
    include_bytes!("golden/v22_event_cont_close.bin"),
    include_bytes!("golden/v22_action_repair_piece.bin"),
    include_bytes!("golden/v22_action_repair_deploy.bin"),
    include_bytes!("golden/v22_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v22_event_piece_repaired_deploy.bin"),
];
...
fn test_protocol_golden() {
    ...
    assert_eq!(GOLDEN.len(), 70, "a new fixture must be dispatched above");
}
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v22_action_repair_piece.bin" | "v22_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v22_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v22_action_container.bin" | "v22_action_container_close.bin" => {
            let (kind, cont) = if name == "v22_action_container.bin" {
                action_container()
            } else {
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v22_event_slot_harvested.bin" | "v22_event_slot_respawned.bin" => {
            let harvested = name == "v22_event_slot_harvested.bin";
        ...
        "v22_event_piece_removed.bin" | "v22_event_deploy_removed.bin" => {
            let piece = name == "v22_event_piece_removed.bin";
        ...
        n @ ("v22_event_struct_hit_piece.bin" | "v22_event_struct_hit_deploy.bin") => {
        ...
        "v22_event_piece_repaired_piece.bin" | "v22_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v22_event_piece_repaired_piece.bin" {
