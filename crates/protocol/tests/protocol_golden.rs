...
use protocol::goldens::{
    ...
    action_consume, action_upgrade, action_use, chat, event_bag_dropped, event_bag_removed,
    event_bag_sync,
    event_build_refused, event_catalog, event_chat, event_craft_done, event_craft_q,
    event_craft_refused, event_death, event_deploy_defs, event_deploy_placed, event_deploy_refused,
    event_deploy_sync, event_door, event_gather, event_health, event_hit, event_inv,
    event_piece_defs, event_piece_placed, event_piece_sync, event_recipes, event_removed,
    event_consume_refused, event_consumed, event_slot_change, event_slot_sync,
    event_stock, event_struct_hit_deploy, event_vitals,
    event_struct_hit_piece, event_weak_mark, hello, input_acks_only, input_full, refuse_full,
...
use protocol::{
    ...
    decode_snapshot, decode_welcome, encode_action_cancel, encode_action_craft,
    encode_action_deploy, encode_action_feed, encode_action_lock, encode_action_loot,
    encode_action_consume, encode_action_place, encode_action_upgrade, encode_action_use,
    encode_chat,
