...
use protocol::goldens::{
    ...
    event_drank, event_gather, event_gather_refused, event_health, event_hit, event_inv,
    event_knock, event_known, event_move_refused, event_moved, event_oven_lit, event_oven_out,
    event_piece_defs, event_piece_placed, event_piece_repaired_deploy, event_piece_repaired_piece,
    event_piece_sync, event_recipes, event_removed, event_research, event_research_refused,
    event_research_rows, event_respawn, event_shot, event_slot_change, event_slot_sync,
    event_stock, event_struct_hit_deploy, event_struct_hit_piece, event_vitals, event_weak_mark,
...
const GOLDEN: [&[u8]; 93] = [
    include_bytes!("golden/v42_input_acks_only.bin"),
    include_bytes!("golden/v42_input_full.bin"),
    include_bytes!("golden/v42_snapshot_keyframe.bin"),
    include_bytes!("golden/v42_snapshot_delta.bin"),
    include_bytes!("golden/v42_snapshot_cap.bin"),
    include_bytes!("golden/v42_hello.bin"),
    include_bytes!("golden/v42_welcome.bin"),
    include_bytes!("golden/v42_refuse_full.bin"),
    include_bytes!("golden/v42_event_gather.bin"),
    include_bytes!("golden/v42_event_inv.bin"),
    include_bytes!("golden/v42_event_slot_harvested.bin"),
    include_bytes!("golden/v42_event_slot_respawned.bin"),
    include_bytes!("golden/v42_event_slot_sync.bin"),
    include_bytes!("golden/v42_event_catalog.bin"),
    include_bytes!("golden/v42_event_weak_mark.bin"),
    include_bytes!("golden/v42_event_craft_q.bin"),
    include_bytes!("golden/v42_event_craft_done.bin"),
    include_bytes!("golden/v42_event_craft_refused.bin"),
    include_bytes!("golden/v42_event_recipes.bin"),
    include_bytes!("golden/v42_action_craft.bin"),
    include_bytes!("golden/v42_action_cancel.bin"),
    include_bytes!("golden/v42_action_place.bin"),
    include_bytes!("golden/v42_event_piece_placed.bin"),
    include_bytes!("golden/v42_event_piece_sync.bin"),
    include_bytes!("golden/v42_event_build_refused.bin"),
    include_bytes!("golden/v42_event_piece_defs.bin"),
    include_bytes!("golden/v42_action_deploy.bin"),
    include_bytes!("golden/v42_action_feed.bin"),
    include_bytes!("golden/v42_event_deploy_placed.bin"),
    include_bytes!("golden/v42_event_deploy_sync.bin"),
    include_bytes!("golden/v42_event_deploy_refused.bin"),
    include_bytes!("golden/v42_event_deploy_defs.bin"),
    include_bytes!("golden/v42_event_piece_removed.bin"),
    include_bytes!("golden/v42_event_deploy_removed.bin"),
    include_bytes!("golden/v42_event_stock.bin"),
    include_bytes!("golden/v42_action_use.bin"),
    include_bytes!("golden/v42_action_access.bin"),
    include_bytes!("golden/v42_event_door.bin"),
    include_bytes!("golden/v42_action_upgrade.bin"),
    include_bytes!("golden/v42_chat.bin"),
    include_bytes!("golden/v42_event_chat.bin"),
    include_bytes!("golden/v42_event_hit.bin"),
    include_bytes!("golden/v42_event_health.bin"),
    include_bytes!("golden/v42_event_death.bin"),
    include_bytes!("golden/v42_action_loot.bin"),
    include_bytes!("golden/v42_event_bag_dropped.bin"),
    include_bytes!("golden/v42_event_bag_sync.bin"),
    include_bytes!("golden/v42_event_bag_removed.bin"),
    include_bytes!("golden/v42_event_struct_hit_piece.bin"),
    include_bytes!("golden/v42_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v42_event_vitals.bin"),
    include_bytes!("golden/v42_event_consumed.bin"),
    include_bytes!("golden/v42_event_consume_refused.bin"),
    include_bytes!("golden/v42_action_consume.bin"),
    include_bytes!("golden/v42_event_drank.bin"),
    include_bytes!("golden/v42_action_drink.bin"),
    include_bytes!("golden/v42_event_respawn.bin"),
    include_bytes!("golden/v42_action_respawn.bin"),
    include_bytes!("golden/v42_action_move.bin"),
    include_bytes!("golden/v42_event_moved.bin"),
    include_bytes!("golden/v42_event_move_refused.bin"),
    include_bytes!("golden/v42_action_move_box.bin"),
    include_bytes!("golden/v42_action_container.bin"),
    include_bytes!("golden/v42_action_container_close.bin"),
    include_bytes!("golden/v42_event_cont_sync.bin"),
    include_bytes!("golden/v42_event_cont_close.bin"),
    include_bytes!("golden/v42_action_repair_piece.bin"),
    include_bytes!("golden/v42_action_repair_deploy.bin"),
    include_bytes!("golden/v42_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v42_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v42_action_throw_piece.bin"),
    include_bytes!("golden/v42_action_throw_deploy.bin"),
    include_bytes!("golden/v42_event_charge_placed_piece.bin"),
    include_bytes!("golden/v42_event_charge_placed_deploy.bin"),
    include_bytes!("golden/v42_challenge.bin"),
    include_bytes!("golden/v42_auth.bin"),
    include_bytes!("golden/v42_event_oven_lit.bin"),
    include_bytes!("golden/v42_event_oven_out.bin"),
    include_bytes!("golden/v42_event_knock.bin"),
    include_bytes!("golden/v42_event_auth.bin"),
    include_bytes!("golden/v42_action_access_crew.bin"),
    include_bytes!("golden/v42_action_demolish.bin"),
    include_bytes!("golden/v42_event_shot.bin"),
    include_bytes!("golden/v42_action_container_world.bin"),
    include_bytes!("golden/v42_action_move_world.bin"),
    include_bytes!("golden/v42_event_cont_sync_world.bin"),
    include_bytes!("golden/v42_action_unlock.bin"),
    include_bytes!("golden/v42_event_research_rows.bin"),
    include_bytes!("golden/v42_event_research.bin"),
    include_bytes!("golden/v42_event_research_refused.bin"),
    include_bytes!("golden/v42_event_known.bin"),
    include_bytes!("golden/v42_action_research.bin"),
    include_bytes!("golden/v42_event_gather_refused.bin"),
];
...
fn test_protocol_golden() {
    ...
    assert_eq!(GOLDEN.len(), 93, "a new fixture must be dispatched above");
}
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v42_action_move_box.bin" | "v42_action_move_world.bin" => {
            let (cont, from_kind, from_slot, to_kind, to_slot, count) =
                if name == "v42_action_move_box.bin" {
                    action_move_box()
                } else {
                    action_move_world()
                };
        ...
        "v42_action_repair_piece.bin" | "v42_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v42_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v42_action_throw_piece.bin" | "v42_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v42_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        "v42_action_container.bin"
        | "v42_action_container_close.bin"
        | "v42_action_container_world.bin" => {
            let (kind, cont) = match name {
                "v42_action_container.bin" => action_container(),
                "v42_action_container_world.bin" => action_container_world(),
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v42_event_research_refused.bin" => {
        ...
        "v42_event_slot_harvested.bin" | "v42_event_slot_respawned.bin" => {
            let harvested = name == "v42_event_slot_harvested.bin";
        ...
        "v42_event_piece_removed.bin" | "v42_event_deploy_removed.bin" => {
            let piece = name == "v42_event_piece_removed.bin";
        ...
        n @ ("v42_event_struct_hit_piece.bin" | "v42_event_struct_hit_deploy.bin") => {
        ...
        "v42_event_cont_sync.bin" | "v42_event_cont_sync_world.bin" => {
            let (kind, cont, reset, rows) = if name == "v42_event_cont_sync.bin" {
                event_cont_sync()
            } else {
        ...
        "v42_event_piece_repaired_piece.bin" | "v42_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v42_event_piece_repaired_piece.bin" {
        ...
        "v42_event_charge_placed_piece.bin" | "v42_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v42_event_charge_placed_piece.bin" {
        ...
        "v42_event_oven_lit.bin" | "v42_event_oven_out.bin" => {
            let (cx, cz, level, lit, by) = if name == "v42_event_oven_lit.bin" {
                event_oven_lit()
            } else {
                event_oven_out()
            };
