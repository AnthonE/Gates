...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v69_action_move_box.bin" | "v69_action_move_world.bin" | "v69_action_move_wear.bin" => {
            let (cont, from_kind, from_slot, to_kind, to_slot, count) = match name {
                "v69_action_move_box.bin" => action_move_box(),
                "v69_action_move_world.bin" => action_move_world(),
                _ => action_move_wear(),
            };
            assert_eq!(
                decode_action(fixture).unwrap(),
        ...
        "v69_action_repair_piece.bin" | "v69_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v69_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v69_action_throw_piece.bin" | "v69_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v69_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        "v69_action_container.bin"
        | "v69_action_container_close.bin"
        | "v69_action_container_world.bin"
        | "v69_action_container_wear.bin" => {
            let (kind, cont) = match name {
                "v69_action_container.bin" => action_container(),
                "v69_action_container_world.bin" => action_container_world(),
                "v69_action_container_wear.bin" => action_container_wear(),
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v69_event_research_refused.bin" => {
        ...
        "v69_event_slot_harvested.bin" | "v69_event_slot_respawned.bin" => {
            let harvested = name == "v69_event_slot_harvested.bin";
        ...
        "v69_event_piece_removed.bin" | "v69_event_deploy_removed.bin" => {
            let piece = name == "v69_event_piece_removed.bin";
        ...
        "v69_event_move_refused.bin" | "v69_event_move_refused_wear.bin" => {
            let (reason, from_kind, from_slot, to_kind, to_slot) =
                if name == "v69_event_move_refused.bin" {
                    event_move_refused()
                } else {
        ...
        n @ ("v69_event_struct_hit_piece.bin" | "v69_event_struct_hit_deploy.bin") => {
        ...
        "v69_event_cont_sync.bin" | "v69_event_cont_sync_world.bin" => {
            let (kind, cont, reset, rows) = if name == "v69_event_cont_sync.bin" {
                event_cont_sync()
            } else {
        ...
        "v69_event_piece_repaired_piece.bin" | "v69_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v69_event_piece_repaired_piece.bin" {
        ...
        "v69_event_charge_placed_piece.bin" | "v69_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v69_event_charge_placed_piece.bin" {
        ...
        "v69_event_oven_lit.bin" | "v69_event_oven_out.bin" => {
            let (cx, cz, level, lit, by) = if name == "v69_event_oven_lit.bin" {
                event_oven_lit()
            } else {
                event_oven_out()
            };
