...
const GOLDEN: [&[u8]; 96] = [
    include_bytes!("golden/v49_input_acks_only.bin"),
    include_bytes!("golden/v49_input_full.bin"),
    include_bytes!("golden/v49_snapshot_keyframe.bin"),
    include_bytes!("golden/v49_snapshot_delta.bin"),
    include_bytes!("golden/v49_snapshot_cap.bin"),
    include_bytes!("golden/v49_hello.bin"),
    include_bytes!("golden/v49_welcome.bin"),
    include_bytes!("golden/v49_refuse_full.bin"),
    include_bytes!("golden/v49_event_gather.bin"),
    include_bytes!("golden/v49_event_inv.bin"),
    include_bytes!("golden/v49_event_slot_harvested.bin"),
    include_bytes!("golden/v49_event_slot_respawned.bin"),
    include_bytes!("golden/v49_event_slot_sync.bin"),
    include_bytes!("golden/v49_event_catalog.bin"),
    include_bytes!("golden/v49_event_weak_mark.bin"),
    include_bytes!("golden/v49_event_craft_q.bin"),
    include_bytes!("golden/v49_event_craft_done.bin"),
    include_bytes!("golden/v49_event_craft_refused.bin"),
    include_bytes!("golden/v49_event_recipes.bin"),
    include_bytes!("golden/v49_action_craft.bin"),
    include_bytes!("golden/v49_action_cancel.bin"),
    include_bytes!("golden/v49_action_place.bin"),
    include_bytes!("golden/v49_event_piece_placed.bin"),
    include_bytes!("golden/v49_event_piece_sync.bin"),
    include_bytes!("golden/v49_event_build_refused.bin"),
    include_bytes!("golden/v49_event_piece_defs.bin"),
    include_bytes!("golden/v49_action_deploy.bin"),
    include_bytes!("golden/v49_action_feed.bin"),
    include_bytes!("golden/v49_event_deploy_placed.bin"),
    include_bytes!("golden/v49_event_deploy_sync.bin"),
    include_bytes!("golden/v49_event_deploy_refused.bin"),
    include_bytes!("golden/v49_event_deploy_defs.bin"),
    include_bytes!("golden/v49_event_piece_removed.bin"),
    include_bytes!("golden/v49_event_deploy_removed.bin"),
    include_bytes!("golden/v49_event_stock.bin"),
    include_bytes!("golden/v49_action_use.bin"),
    include_bytes!("golden/v49_action_access.bin"),
    include_bytes!("golden/v49_event_door.bin"),
    include_bytes!("golden/v49_action_upgrade.bin"),
    include_bytes!("golden/v49_chat.bin"),
    include_bytes!("golden/v49_event_chat.bin"),
    include_bytes!("golden/v49_event_hit.bin"),
    include_bytes!("golden/v49_event_health.bin"),
    include_bytes!("golden/v49_event_death.bin"),
    include_bytes!("golden/v49_action_loot.bin"),
    include_bytes!("golden/v49_event_bag_dropped.bin"),
    include_bytes!("golden/v49_event_bag_sync.bin"),
    include_bytes!("golden/v49_event_bag_removed.bin"),
    include_bytes!("golden/v49_event_struct_hit_piece.bin"),
    include_bytes!("golden/v49_event_struct_hit_deploy.bin"),
    include_bytes!("golden/v49_event_vitals.bin"),
    include_bytes!("golden/v49_event_consumed.bin"),
    include_bytes!("golden/v49_event_consume_refused.bin"),
    include_bytes!("golden/v49_action_consume.bin"),
    include_bytes!("golden/v49_event_drank.bin"),
    include_bytes!("golden/v49_action_drink.bin"),
    include_bytes!("golden/v49_event_respawn.bin"),
    include_bytes!("golden/v49_action_respawn.bin"),
    include_bytes!("golden/v49_action_move.bin"),
    include_bytes!("golden/v49_event_moved.bin"),
    include_bytes!("golden/v49_event_move_refused.bin"),
    include_bytes!("golden/v49_action_move_box.bin"),
    include_bytes!("golden/v49_action_container.bin"),
    include_bytes!("golden/v49_action_container_close.bin"),
    include_bytes!("golden/v49_event_cont_sync.bin"),
    include_bytes!("golden/v49_event_cont_close.bin"),
    include_bytes!("golden/v49_action_repair_piece.bin"),
    include_bytes!("golden/v49_action_repair_deploy.bin"),
    include_bytes!("golden/v49_event_piece_repaired_piece.bin"),
    include_bytes!("golden/v49_event_piece_repaired_deploy.bin"),
    include_bytes!("golden/v49_action_throw_piece.bin"),
    include_bytes!("golden/v49_action_throw_deploy.bin"),
    include_bytes!("golden/v49_event_charge_placed_piece.bin"),
    include_bytes!("golden/v49_event_charge_placed_deploy.bin"),
    include_bytes!("golden/v49_challenge.bin"),
    include_bytes!("golden/v49_auth.bin"),
    include_bytes!("golden/v49_event_oven_lit.bin"),
    include_bytes!("golden/v49_event_oven_out.bin"),
    include_bytes!("golden/v49_event_knock.bin"),
    include_bytes!("golden/v49_event_auth.bin"),
    include_bytes!("golden/v49_action_access_crew.bin"),
    include_bytes!("golden/v49_action_demolish.bin"),
    include_bytes!("golden/v49_event_shot.bin"),
    include_bytes!("golden/v49_action_container_world.bin"),
    include_bytes!("golden/v49_action_move_world.bin"),
    include_bytes!("golden/v49_event_cont_sync_world.bin"),
    include_bytes!("golden/v49_action_unlock.bin"),
    include_bytes!("golden/v49_event_research_rows.bin"),
    include_bytes!("golden/v49_event_research.bin"),
    include_bytes!("golden/v49_event_research_refused.bin"),
    include_bytes!("golden/v49_event_known.bin"),
    include_bytes!("golden/v49_action_research.bin"),
    include_bytes!("golden/v49_event_gather_refused.bin"),
    include_bytes!("golden/v49_event_bags.bin"),
    include_bytes!("golden/v49_event_impact.bin"),
    include_bytes!("golden/v49_event_swing.bin"),
];
...
fn golden_action(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v49_action_move_box.bin" | "v49_action_move_world.bin" => {
            let (cont, from_kind, from_slot, to_kind, to_slot, count) =
                if name == "v49_action_move_box.bin" {
                    action_move_box()
                } else {
                    action_move_world()
                };
        ...
        "v49_action_repair_piece.bin" | "v49_action_repair_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v49_action_repair_piece.bin" {
                action_repair_piece()
            } else {
        ...
        "v49_action_throw_piece.bin" | "v49_action_throw_deploy.bin" => {
            let (deploy, cx, cz, level, loc) = if name == "v49_action_throw_piece.bin" {
                action_throw_piece()
            } else {
                action_throw_deploy()
            };
        ...
        | "v49_action_container_world.bin" => {
            let (kind, cont) = match name {
                "v49_action_container.bin" => action_container(),
                "v49_action_container_world.bin" => action_container_world(),
...
fn golden_event(fixture: &[u8], name: &str) {
    ...
    let len = match name {
        ...
        "v49_event_slot_harvested.bin" | "v49_event_slot_respawned.bin" => {
            let harvested = name == "v49_event_slot_harvested.bin";
        ...
        "v49_event_piece_removed.bin" | "v49_event_deploy_removed.bin" => {
            let piece = name == "v49_event_piece_removed.bin";
        ...
        n @ ("v49_event_struct_hit_piece.bin" | "v49_event_struct_hit_deploy.bin") => {
        ...
        "v49_event_cont_sync.bin" | "v49_event_cont_sync_world.bin" => {
            let (kind, cont, reset, rows) = if name == "v49_event_cont_sync.bin" {
                event_cont_sync()
            } else {
        ...
        "v49_event_piece_repaired_piece.bin" | "v49_event_piece_repaired_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, healed, hp) =
                if name == "v49_event_piece_repaired_piece.bin" {
        ...
        "v49_event_charge_placed_piece.bin" | "v49_event_charge_placed_deploy.bin" => {
            let (deploy, cx, cz, level, loc, row, fuse) =
                if name == "v49_event_charge_placed_piece.bin" {
        ...
        "v49_event_oven_lit.bin" | "v49_event_oven_out.bin" => {
            let (cx, cz, level, lit, by) = if name == "v49_event_oven_lit.bin" {
                event_oven_lit()
            } else {
                event_oven_out()
            };
